  ...
  return (
    <div className="w-full max-w-md h-full min-w-0">
      ...
      <div className="perspective h-full w-full">
        ...
        >
          {/* Front */}
          <div className="relative inset-0 backface-hidden bg-gray-700 rounded-xl overflow-hidden border border-cyan-500/20 shadow-2xl shadow-cyan-500/10 hover:border-cyan-400/60 hover:shadow-cyan-400/20 transition-all duration-500 min-h-[470px] sm:min-h-[500px] md:min-h-[560px]">
            {/* Neon glow */}
            <div className="relative inset-0 rounded-xl bg-cyan-500/5 opacity-70 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          {/* Back */}
          <div className="absolute inset-0 backface-hidden rotate-y-180 bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-xl overflow-hidden border border-cyan-500/50 shadow-2xl shadow-cyan-500/30 min-h-[470px] sm:min-h-[500px] md:min-h-[560px]">
            {/* Glow */}
            <div className="absolute inset-0 rounded-xl bg-cyan-500/10 opacity-80 group-hover:opacity-100 transition-opacity duration-500"></div>
