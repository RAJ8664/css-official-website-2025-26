...
const CompleteProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Force a reload or context refresh to get the new profile data
    ...
    return (
        <div className="relative min-h-screen bg-[linear-gradient(to_right,#000000_55%,#021547_100%)] text-white flex items-center justify-center px-6 py-10">
            <div className="relative max-w-md w-full bg-black/70 border border-cyan-500/30 rounded-2xl p-8 shadow-[0_0_25px_rgba(6,182,212,0.4)] backdrop-blur-lg">
                ...
                {error && <p className="bg-red-900/50 text-red-300 text-center p-3 rounded-md mb-4">{error}</p>}
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input
                            type="text"
                            className="w-full p-3 rounded bg-gray-800/50 border-2 border-gray-700 focus:outline-none focus:border-cyan-500"
                            value={fullName}
